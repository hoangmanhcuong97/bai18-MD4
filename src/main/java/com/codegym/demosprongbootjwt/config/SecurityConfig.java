package com.codegym.demosprongbootjwt.config;

import com.codegym.demosprongbootjwt.rest.CustomAccessDeniedHandler;
import com.codegym.demosprongbootjwt.rest.JwtAuthenticationTokenFilter;
import com.codegym.demosprongbootjwt.rest.RestAuthenticationEntryPoint;
...
//    Trường hợp người dùng gửi request mà không có quyền sẽ
//    do bean customAccessDeniedHandler xử lý (Ví dụ role USER nhưng gửi request xóa user)
    @Bean
